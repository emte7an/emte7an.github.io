  ...
  return (
    <div className="w-full h-screen !bg-white flex flex-col items-center justify-center">
      ...
      <div className="space-y-4">
        ...
        <div className="pt-4">
          <h2 className="text-xl font-semibold mb-3">تواصل معنا عبر واتساب</h2>
          <div className="flex justify-center items-center gap-4 pt-2">
            
            {/* WhatsApp */}
            <a href="https://wa.me/201276704477" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-green-500 text-white rounded-full hover:bg-green-600 shadow-md transition-all duration-200 flex items-center justify-center">
